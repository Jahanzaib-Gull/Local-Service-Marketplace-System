...
import { Wrench, Bell, CheckCircle, MoreHorizontal, PlusCircle, Activity, Layout, Star } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8 px-2">
            <h3 className="text-2xl font-black text-slate-900 tracking-tight">Jobs in Progress</h3>
            <span className="px-4 py-1.5 bg-indigo-50 text-indigo-600 rounded-full text-xs font-black uppercase tracking-widest">Ongoing Interactions</span>
          </div>
            ...
            {recentBookings.length > 0 ? recentBookings.map(booking => (
              <div key={booking._id} className="bg-white border border-slate-100 rounded-[3rem] p-10 shadow-xl shadow-slate-100/50 hover:border-indigo-200 transition-all group">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="px-4 py-2 bg-emerald-50 text-emerald-600 rounded-xl text-[10px] font-black uppercase tracking-widest">Accepted</span>
                </div>
                ...
                <div className="flex items-center gap-2 mb-8">
                  ...
                  <span className="text-sm font-bold text-slate-500">Service by <span className="text-slate-900">{booking.provider?.name}</span></span>
                </div>
                <Button 
              ...
              <div className="md:col-span-2 py-12 bg-white border border-dashed border-slate-200 rounded-[3rem] flex flex-col items-center justify-center text-slate-400 opacity-60">
                ...
                <p className="font-bold">No jobs currently in progress</p>
              </div>
            )}
          </div>
        </div>
                  ...
                  <tr>
                    <td colSpan="5" className="px-10 py-20 text-center">
                      <div className="flex flex-col items-center opacity-30">
                        ...
                        <p className="font-black text-xl">No requests found</p>
                      </div>
                    </td>
                  </tr>
                )}
